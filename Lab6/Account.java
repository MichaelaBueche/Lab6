...
public class Account
{
  ...
  public Account(int aAccountNumber, String aNameForCustomer, boolean aReturningCustomerForCustomer)
  {
    accountNumber = aAccountNumber;
    customer = new Customer(aNameForCustomer, aReturningCustomerForCustomer, this);
    orders = new ArrayList<Order>();
  }
